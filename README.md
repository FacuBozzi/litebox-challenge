This is a [Next.js](https://nextjs.org) project bootstrapped with [`create-next-app`](https://nextjs.org/docs/app/api-reference/cli/create-next-app). The latest deployment lives [here](https://litebox-challenge-phi.vercel.app/).
